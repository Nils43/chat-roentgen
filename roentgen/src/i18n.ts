...
const dict = {
  ...
  de: {
    ...
    // Paywall
    'paywall.marker': '✦ LETZTE SLIDE · DER DEEP TEA',
    'paywall.kicker.two': '→ zwei analysen · €3 pro stück · €5 im bundle',
    'paywall.kicker.one': '→ persönliche akte · €3',
    'paywall.hero.prefix': 'DER TIEFE ',
    'paywall.hero.highlight': 'TEA.',
    'paywall.sub.prefix': 'die zahlen waren das ',
    'paywall.sub.what': 'was',
    'paywall.sub.two': 'zwei analysen sind das ',
    'paywall.sub.one': 'die persönliche akte ist das ',
    'paywall.sub.why': 'warum',
    'paywall.file.about': 'über',
    'paywall.file01.title': 'PERSÖNLICHE ANALYSE.',
    'paywall.file01.lede':
      'eine KI-geschriebene psychologische Lesart, wie {name} in diesem Chat schreibt — Patterns, Tells, die Moves, die du immer wieder machst. Du willigst vorher ein, bevor was dein Gerät verlässt.',
    'paywall.file02.title': 'BEZIEHUNGSANALYSE.',
    'paywall.file02.lede':
      'eine KI-geschriebene Lesart, was wirklich zwischen {a} und {b} läuft — wer mehr gibt, die ungesagten Regeln, wer wann führt. Du willigst vorher ein, bevor was dein Gerät verlässt.',
    'paywall.unlock': 'UNLOCKEN',
    'paywall.open': 'OPEN →',
    'paywall.yours': '✓ DEINS',
    'paywall.bundle.kicker': 'beide files · das bundle',
    'paywall.endOfTape': '· das war der shallow tea ·',
    ...
    // Closing
    'closing.kicker': 'exhibit geschlossen · {n} nachrichten gelesen',
    'closing.hero.prefix': 'DAS WAR DER ',
    'closing.hero.highlight': 'TEA.',
    'closing.body.top': 'der tea ist raus. ein angebot. der rest gehört dir.',
    'closing.body.bottom': 'öffne den chat wann du willst — jetzt zum scrollen.',
    ...
    // Hard Facts — Opener
    'hf.opener.intel': 'intel · {people} · archiviert',
    'hf.opener.hero': 'INSIGHTS',
    'hf.opener.mcount': '{n} Messages',
    'hf.opener.days': '{n} Tage',
    'hf.opener.group.voices': '{n} Voices',
    'hf.opener.group.talking': '{leader} macht {pct}% der Convo',
    ...
    'hf.firstPause': 'Nach einer Pause von 4 Stunden oder mehr · {n} Mal insgesamt',
    'hf.firstOfDay': 'Erste Message des Tages',
    'hf.lastOfDay': 'Letzte Message des Tages',
    ...
    'hf.04.body': 'Late-Night-Messages (23–5 Uhr) und Burst-Sequenzen (3+ Messages ohne Antwort). Wenn die Maske rutscht.',
    ...
    'hf.06.kicker': '06 · Effort',
    'hf.06.title': 'Wer gibt One-Word-Replies?',
    'hf.06.body': '{pct}% der Messages von {name} sind 3 Wörter oder weniger. Kurze Replies sind nicht immer bad — summieren sich aber.',
    'hf.07.kicker': '07 · First & last',
    'hf.07.title': 'Wer startet den Tag — wer endet ihn?',
    'hf.07.body': 'Von {n} aktiven Tagen. Wer morgens als Erste:r schreibt, denkt an die andere Person, bevor sonst was passiert.',
    'hf.08.kicker': '08 · Über die Zeit',
    'hf.08.title': 'Wie sich dieser Chat verändert hat',
    'hf.arc.up': 'Der Chat heizt auf. Die letzten Wochen hatten {pct}% mehr Messages als am Anfang. Peak-Woche: {week} mit {n} Messages.',
    'hf.arc.down': 'Der Chat kühlt ab. Die letzten Wochen hatten {pct}% weniger Messages als am Anfang. Peak-Woche: {week} mit {n} Messages.',
    'hf.arc.flat': 'Das Message-Volume ist ungefähr stabil geblieben. Peak-Woche: {week} mit {n} Messages.',
    'hf.shift.label': 'Wer hält die Connection',
    'hf.shift.firstHalf': 'Erste Hälfte',
    'hf.shift.secondHalf': 'Zweite Hälfte',
    'hf.shift.swap': 'Initiative gekippt. Früher hat {a} die meisten Convos gestartet. Jetzt ist es {b}.',
    'hf.shift.same': '{leader} hält die Initiative durchgehend — {direction} um {pct} Punkte.',
    'hf.shift.dropped': 'gedroppt',
    'hf.shift.rose': 'gestiegen',
    'hf.shift.steady': 'stabil geblieben',
